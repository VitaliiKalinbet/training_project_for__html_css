...
const LeftTool = ({ toggleHeader, toggleMain, toggleFooter, toggleSectionServices, toggleshowSectionTeam, showHeader, showMain, showFooter, showSectionServices, showSectionTeam }) => {
    return (
        <div className={s.toolSection}>
            <Link to="header" spy={true} smooth={true} offset={50} duration={500} delay={10}>
                <button onClick={toggleHeader} className={showHeader ? s.checkedButton : s.button}>
                    {showHeader ? "hide header" : "show header"}
                </button>
            </Link>
            <Link to="footer" spy={true} smooth={true} offset={50} duration={500} delay={10}>
            ...
            <Link to="services" spy={true} smooth={true} offset={50} duration={500} delay={10}>
            ...
            <Link to="team" spy={true} smooth={true} offset={50} duration={500} delay={10}>
